...
public:
	WishList(string posesorLista, int nrCadouri, Cadou** listaCadouri) {
...
int main()
{
	...
	Cadou* listaCadouri[3] = { &c1,&c2,&c3 };
	WishList w("DZM", 3, listaCadouri);
	cout << w;

	//float pretMinim = (float)w;
	//Cadou c4 = w[0];
	return 0;
}