...
//TO DO: gestiunea centralizata a salariatilor+salariile din ASE
int main()
{
	...
	listaA[0] = a;
	listaA[1] = p2;//apel op= din Angajat + upcast implicit
	for (int i = 0; i < 2; i++)
		salariuTotal += listaA[i].calculSalariu();
	cout << "\nSalariu total angajati ASE: " << salariuTotal;
	...
	cout << "\nSalariu total angajati ASE: " << salariuTotal2;
	cout << "\n****************************";
	return 0;
}